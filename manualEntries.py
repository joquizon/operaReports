...
def manuaQ(arrivalsMainVar,walkDataVar,LateCxlDataVar):
    ...
    Button(window, text='No Show',font='helvetica 10 italic',width = 9,height=4,background ='dodger blue',  command =manNoS ) .grid(row= 2, column= 0,padx=25, pady =10, sticky = N)
    Button(window, text='Walk',font='helvetica 10 italic',width = 9,height=4,background ='deep sky blue',  command = manWalk) .grid(row= 3, column= 0,padx=25, pady =10, sticky = N)
    Button(window, text='Late Cxl',font='helvetica 10 italic',width = 9,height=4,background ='blue2',  command = manCxl) .grid(row= 4, column= 0,padx=25, pady =10, sticky = N)

    Button(window, text='NoNe',fg='white',font='helvetica 10 italic',width = 9,height=4,background ='red' ,command = no) .grid(row= 5, column= 0,padx=25,pady =10, sticky = N)
...
#     Label (window, image = photo1, bg= 'gray') .grid(row =0, column = 2, sticky =E)
    ...
    # sets properties and creates text in the window ... bg is text background fg is(foreground) color for font
    Label (window, text='Manually Enter - Walked Guests',bg = labelBG, fg='black', font='helvetica 15 italic') .grid (row = 0,column='0', sticky = E)
    Label (window, text='Late Cxl',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='0', sticky = E)
    Label (window, text='Res No.',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='1', sticky = E)
    Label (window, text='Reason',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='2', sticky = E)
    Label (window, text='Company',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='3', sticky = E)
    Label (window, text='Group',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='4', sticky = E)
    Label (window, text='Travel Agent',bg = labelBG, fg=labelFG, font=labelfont) .grid (row = 1,column='5', sticky = E)
    ...
    btn2=Button(window, text='Done',font='helvetica 12 italic',width = 9,height=4,background ='dodger blue', command = CxlmanEnd) .grid(row= 9, padx=25, column= 0, sticky = W)
